...
#else
#define USBD_VID                        0x0483			//0x0483	- mode 0
#define USBD_VID2                       0x0484			//0x0484	- mode 1

#define USBD_PID                        0x5730			//0x5730
...
void USBD_ConfigurePID(int mode)
{
	...
	if (mode == 0)
	{
		USBD_DeviceDesc[8] = LOBYTE(USBD_VID);           /*idVendor*/
		USBD_DeviceDesc[9] = HIBYTE(USBD_VID);
	}
	else
	{
		USBD_DeviceDesc[8] = LOBYTE(USBD_VID2);          /*idVendor*/
		USBD_DeviceDesc[9] = HIBYTE(USBD_VID2);
	}
#endif
}
