...
extern void usbd_ConfigureAudio(int mode);
extern void USBD_ConfigurePID(int mode);

void USBD_Init(int mode,
...
{
  /* patch the descriptors for the Audio format */
#ifdef USB_AUDIO
  usbd_ConfigureAudio(mode);
  USBD_ConfigurePID(mode);
#endif
