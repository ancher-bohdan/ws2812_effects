...
C_SOURCES = $(SOURCES_STD_PERIPH) $(SOURCES_CMSIS) $(SOURCES_APP) $(SOURCES_DRIVERS) $(SOURCES_USB) $(SOURCES_WS_ADAPTER) $(SOURCES_WS_DRIVER) $(SOURCES_WS_SOURCE)
